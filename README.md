[index.html](https://github.com/user-attachments/files/22675336/index.html)
...
<body>
  <header>📊 Task Management Tracker Operasional Surprice</header>  <!-- REGISTER -->  <div id="register" class="register-box">
    <h2>Register</h2>
    <p>Buat akun baru</p>
